...
<?php
        ...
        $check="SELECT * from review where appName='$appName' order by review_ID desc";
...
?>
  ...
  ?>
<button type="button" onClick="location.href='./view2.php?appName=<?php echo $rows['appName'] ?>'" style="height:40px; width:350px;">리뷰 수정</button>
